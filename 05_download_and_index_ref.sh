...
#SBATCH --out=pop_gen/slurm/download_and_index_ref_slurm-%j.out
...
RCLONE_FILE_PATH='pawsey1228:afgi.atims/reference_genomes/l_punctulatus/l_punctulatus_OG2146_v260414.hic1.3.curated.hap1.chr_level.fa.gz'
